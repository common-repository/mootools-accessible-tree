...
Triantafillos Tsirelis:
 - minor changes to the image paths,
   so that they are compatible with wordpress.
...
(function(){
    ...
    this.Tree = new Class({
        ...
        initialize: function(element, options){
            ...
            this.element.getElements(self.options.listSelector).each(function(el){
                var imgex = new Element('img', {
                    'class': 'expand',
                    'src': "wp-content/plugins/mootools-accessible-tree/img/Expand.png",
                    'alt': "ExpandCollapse",
        ...
        updateElement: function(el){
             ...
             */
            if (this.isCollapsed(ul)) 
                icon.src = "wp-content/plugins/mootools-accessible-tree/img/Expand.png";
            else 
                icon.src = "wp-content/plugins/mootools-accessible-tree/img/Collapse.png";
...
.bind(this));
        ...
        expand: function(li){
            ...
            li.getElement(this.options.selector).src = "wp-content/plugins/mootools-accessible-tree/img/Collapse.png";
        ...
        collapse: function(li){
            ...
            li.getElement(this.options.selector).src = "wp-content/plugins/mootools-accessible-tree/img/Expand.png";
            li.getElement('span').setProperties({
                'aria-expanded': 'false'
            });
